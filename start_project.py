...
def check_requirements():
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print("Node.js no detectado (opcional para desarrollo)")
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print("npm no detectado (opcional para desarrollo)")
    except FileNotFoundError:
        print("npm no detectado (opcional para desarrollo)")
...
def install_frontend_dependencies():
    ...
    try:
        ...
        print("npm no está disponible, omitiendo instalación del frontend")
        return False
...
def run_frontend():
    ...
    try:
        ...
        print("npm no está disponible, omitiendo frontend")
